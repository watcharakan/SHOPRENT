				...
				<div class="modal-body modal-body-sub">
					<div class="row">
						...
						<input type="submit" value="Sign in"/>
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" placeholder="Name"class="form-control" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                     ...
                                     <li>
                                        <a href="<?php echo e(route('createselling')); ?>">
                                        	ข้อมูลส่วนตัว
                                        </a>
                                    </li>
                                    <li>
